...
export default function InfoDataGrid(props) {
    const { 
        rows, columns, newDegreeButton,  height, setGridApiRef, infoField, infoTitle, money, 
            ...
            <DataGrid
                ...
                componentsProps={{
                    toolbar: {
                        ...
                        newDegreeButton: newDegreeButton
                        
                    },
                    pagination: {
                        excelFileName: 'decretos',
